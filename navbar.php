            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Room <i class="fas fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="">Suite Rooms</a></li>
                        <li><a class="dropdown-item" href="">Queen Size Rooms</a></li>
                        <li><a class="dropdown-item" href="">Standard with A/C Rooms</a></li>
                        <li><a class="dropdown-item" href="">Single with A/C Rooms</a></li>
